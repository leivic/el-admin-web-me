  ...
  <div class="continue-chart-container">
    ...
    <el-row :gutter="16"><!--三个图表组件 布局是elment-ui栅栏布局-->
      <el-col v-loading="chart1.listLoading" :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          <RowBarchart :chart-data="chart1.xdata" :title="chart1.title" :stationdata="chart1.stationdata" :groupdata="chart1.groupdata" :workshopdata="chart1.workshopdata" />
        </div>
      </el-col>
      <el-col v-loading="chart2.listLoading" :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          <RowBarchart :chart-data="chart2.xdata" :title="chart2.title" :stationdata="chart2.stationdata" :groupdata="chart2.groupdata" :workshopdata="chart2.workshopdata" />
        </div>
      </el-col>
      <el-col v-loading="chart3.listLoading" :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          <RowBarchart :chart-data="chart3.xdata" :title="chart3.title" :stationdata="chart3.stationdata" :groupdata="chart3.groupdata" :workshopdata="chart3.workshopdata" />
        </div>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="16"><!--三个图表组件 布局是elment-ui栅栏布局-->
      <el-col v-loading="chart4.listLoading" :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          <RowBarchart :chart-data="chart4.xdata" :title="chart4.title" :stationdata="chart4.stationdata" :groupdata="chart4.groupdata" :workshopdata="chart4.workshopdata" />
        </div>
      </el-col>
      <el-col v-loading="chart5.listLoading" :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          <RowBarchart :chart-data="chart5.xdata" :title="chart5.title" :stationdata="chart5.stationdata" :groupdata="chart5.groupdata" :workshopdata="chart5.workshopdata" />
        </div>
      </el-col>
      <el-col v-loading="chart6.listLoading" :xs="24" :sm="24" :lg="8">
        <div class="chart-wrapper">
          <RowBarchart :chart-data="chart6.xdata" :title="chart6.title" :stationdata="chart6.stationdata" :groupdata="chart6.groupdata" :workshopdata="chart6.workshopdata" />
        </div>
      </el-col>
    </el-row>
