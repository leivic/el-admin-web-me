...
<script>
import { findAllIndexdata1,updateIndexdata1 } from '@/api/qe/other'
export default{
    data(){
        return{
   ...
   methods: {
    ...
    submit(index, row) {
	    console.log(row)
	    updateIndexdata1(row.id,this.show1[index],this.show2[index],this.show3[index],this.show4[index],this.show5[index],this.show6[index],this.show7[index],this.show8[index],this.show9[index],this.show10[index],this.show11[index],this.show12[index]).then(res=>{
