      ...
      <el-form ref="form" :inline="true" :model="form" size="small" label-width="80px">
        <el-form-item label="日期" required>
          ...
          <el-form-item label="区域" prop="zone" required>
            <el-select v-model="form.zone" placeholder="区域" style="width: 200px">
          ...
          <el-form-item  label="x1" prop="title">
            <el-input v-model="form.x1" placeholder="x1" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x2" prop="title">
            <el-input v-model="form.x2" placeholder="x2" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x3" prop="title">
            <el-input v-model="form.x3" placeholder="x3" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x4" prop="title">
            <el-input v-model="form.x4" placeholder="x4" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x5" prop="title">
            <el-input v-model="form.x5" placeholder="x5" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x6" prop="title">
            <el-input v-model="form.x6" placeholder="x6" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x7" prop="title">
            <el-input v-model="form.x7" placeholder="x7" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x8" prop="title">
            <el-input v-model="form.x8" placeholder="x8" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x9" prop="title">
            <el-input v-model="form.x9" placeholder="x9" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x10" prop="title">
            <el-input v-model="form.x10" placeholder="x10" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x11" prop="title">
            <el-input v-model="form.x11" placeholder="x11" style="width: 170px"  />
          </el-form-item>
          <el-form-item  label="x12" prop="title">
            <el-input v-model="form.x12" placeholder="x12" style="width: 170px"  />
          </el-form-item>
      </el-form>
...
<!--表格渲染-->
  <el-table
    ...
    <el-table-column
      align="center"
      prop="x1"
      min-width="33%"><!--奇了怪了 只有min-width可以设置百分比 width不能设置 elmentui封装惹出来的-->
    </el-table-column>
    <el-table-column
      align="center"
      prop="x2"
...
<script>
import {findByzoneanddate,updateorsavecontinuedatasource,findCountcontinuedatasource } from '@/api/qe/continue'
