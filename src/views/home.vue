  ...
  <div class="continue-chart-container">
    ...
    <el-row :gutter="16">
      <el-col v-loading="chart3.listLoading" :xs="24" :sm="24" :lg="12">
        <div class="chart-wrapper">
          <Stackchart :chart-data="chart3.chartdata" :title="chart3.title" :lengenddata="chart3.lengenddata" />
        </div>
      </el-col>

      <el-col v-loading="chart4.listLoading" :xs="24" :sm="24" :lg="12">
        <div class="chart-wrapper">
          <Stackchart :chart-data="chart4.chartdata" :title="chart4.title" :lengenddata="chart3.lengenddata" />
        </div>
      </el-col>
    </el-row>
  </div>
...
export default {
  ...
  methods: {
    ...
    getmontharray() {
      const i = (this.month + '').substring(5, 7)
      console.log(i)
